            ...
            <div className="container py-4 py-md-5 px-4 px-md-3">
                <div className="row">
                    <div className="col-lg-3 mb-3">
                        <a className="navbar-brand" href="/"><img src="./LogoMod.webp" alt="Logo" /></a>
                    ...
                    <div className="col-6 col-lg-2 mb-3">
                        ...
                        <ul className="list-unstyled">
                            ...
                            <li><a className="navItemFooter" href="https://api.whatsapp.com/send/?phone=5491176258842&text&type=phone_number&app_absent=0">Whatsapp</a><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style={{ fill: 'black' }}>
                    ...
                    <div className="col-8 col-lg-2 mb-3">
                        ...
                        <ul className="list-unstyled">
                            <li><a className="navItemFooter" href="tel:+541121187415">11-2118-7415</a><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style={{ fill: 'black', transform: "", msFilter: "" }}>
                            ...
                            <li><a className="navItemFooter" href="mailto:ventas@fymsanitarios.com">ventas@fymsanitarios.com</a><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style={{ fill: 'black', transform: "", msFilter: "" }}>
