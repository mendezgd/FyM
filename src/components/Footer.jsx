            ...
            <div className="container py-4 py-md-5 px-4 px-md-3">
                <div className="row">
                    ...
                    <div className="col-6 col-lg-2 mb-3">
                        ...
                        <ul className="list-unstyled">
                            <li><a className="navItemFooter" href="https://www.instagram.com/fymsanitarios/?hl=es-la">Instagram</a><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" style={{ fill: 'black' }}>
                            ...
                            <li><a className="navItemFooter" href="https://api.whatsapp.com/send/?phone=5491166229213&text&type=phone_number&app_absent=0">Whatsapp</a><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" style={{ fill: 'black' }}>
