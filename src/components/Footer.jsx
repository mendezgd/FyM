                ...
                <div className="row">
                    <div className="col-lg-3 mb-3">
                        ...
                        <ul className="list-unstyled small m-3">
                            <li className="mb-2 mt-4">© 2017 FYM Sanitarios SRL</li>
                        </ul>
                    </div>
                    ...
                    <div className="col-6 col-lg-2 mb-3">
                        ...
                        <ul className="list-unstyled">
                            <li><a className="navItemFooter" href="https://www.instagram.com/fymsanitarios/?hl=es-la">Instagram</a><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" style={{ fill: '#3b86f6' }}>
                            ...
                            <li><a className="navItemFooter" href="https://api.whatsapp.com/send/?phone=5491166229213&text&type=phone_number&app_absent=0">Whatsapp</a><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" style={{ fill: '#3b86f6' }}>
                    ...
                    <div className="col-6 col-lg-2 mb-3">
                        ...
                        <ul className="list-unstyled">
                            <li className="navItemFooter">11-2118-7415<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" style={{ fill: "#3b86f6", transform: "", msFilter: "" }}>
                            ...
                            <li className="navItemFooter">ventas@fymsanitarios.com<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" style={{ fill: "#3b86f6", transform: "", msFilter: "" }}>
