...
const Mapa = () => {
    return (
        <>
            <div className="row">
                <div className="cartas d-flex justify-content-center">
                    <div className="card carta-contacto d-flex justify-content-center align-items-center" style={{ width: '27rem' }}>
